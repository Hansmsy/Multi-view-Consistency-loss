...
class CollateFn(object):
    def __init__(self, label_set, sample_config):
        ...
        self.interval = sample_config['interval']
        ...
        if self.sampler == 'fixed' and self.ordered and self.interval:
            self.rate_min = sample_config['rate_min']
            self.rate_max = sample_config['rate_max']
    ...
    def __call__(self, batch):
        ...
        def sample_frames(seqs):
            ...
            if self.interval:
                rate = random.randint(self.rate_min, self.rate_max)
            else:
                rate = 1
            ...
            if self.sampler in ['fixed', 'unfixed']:
                ...
                if self.ordered:
                    ...
                    idx_lst = idx_lst[start:end:rate]
